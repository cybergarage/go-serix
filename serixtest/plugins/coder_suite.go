...
// CascadeCompressorSuite tests the specified cascade compressor coder.
func CascadeCompressorSuite(t *testing.T, compressor document.ObjectCoder, serializerTestSuite func(t *testing.T, coder document.ObjectCoder)) {
	t.Helper()
