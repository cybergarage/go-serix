...
func PrimitiveObjectTest(t *testing.T, coder document.ObjectCoder) {
	t.Helper()
...
func MapObjectTest(t *testing.T, coder document.ObjectCoder) {
	t.Helper()
...
func ArrayObjectTest(t *testing.T, coder document.ObjectCoder) {
	t.Helper()
